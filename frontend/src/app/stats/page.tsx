...
import type { DetailedDonationStats, DonationCategory, DonationStatus, DonationUnit } from "../../lib/types";
    ...
    <main className="min-h-screen bg-ravively-cream py-8 pl-[120px] pr-4 sm:pr-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="card mb-8">
          ...
          <ul className="space-y-2">
            {(Object.entries(stats.byCategory) as [DonationCategory, number][]).map(([cat, count]) => (
        ...
        <section className="card">
          ...
          <ul className="space-y-2">
            {(Object.entries(stats.byStatus) as [DonationStatus, number][]).map(([status, count]) => (
